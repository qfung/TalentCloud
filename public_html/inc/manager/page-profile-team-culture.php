...
<div id="createEditProfile_teamCulture" class="stepGroup_createEditProfile hidden">
    ...
    <div class="tabsWrapper">
        <div class="tabsSteps">
            <div class="five-step-tab"><a onclick="CreateEditProfileAPI.goToStep('createEditProfile_step1');"><span id="createEditProfileStep1Label_TC">About</span></a></div>
            <div class="five-step-tab"><a onclick="CreateEditProfileAPI.goToStep('createEditProfile_step2');"><span id="createEditProfileStep2Label_TC">Leadership</span></a></div>
            <div class="five-step-tab"><a onclick="CreateEditProfileAPI.goToStep('createEditProfile_workEnvironment');"><span id="createEditProfileWorkEnvironmentLabel_TC">Work Environment</span></a></div>
            <div class="five-step-tab tab-current"><a onclick="CreateEditProfileAPI.goToStep('createEditProfile_teamCulture');"><span id="createEditProfileTeamCultureLabel_TC">Team Culture</span></a></div>
            <div class="five-step-tab"><a onclick="CreateEditProfileAPI.goToStep('createEditProfile_step3');"><span id="createEditProfileStep3Label_TC">Other</span></a></div>
        </div>
        <div class="tabs">
